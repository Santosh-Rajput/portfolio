          ...
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group name="Icosphere_20" position={[-1.272, -0.641, 2.571]} rotation={[0.033, 0.439, 0.135]} scale={[0.631, 0.55, 0.451]}>
                <mesh name="mesh_17" geometry={nodes.mesh_17.geometry} material={materials.fire} morphTargetDictionary={nodes.mesh_17.morphTargetDictionary} morphTargetInfluences={nodes.mesh_17.morphTargetInfluences} />
              </group>
              ...
              <group name="Cylinder002_22" position={[-4.239, 1.916, -13.034]}>
                <mesh name="mesh_19" geometry={nodes.mesh_19.geometry} material={materials.smoke} morphTargetDictionary={nodes.mesh_19.morphTargetDictionary} morphTargetInfluences={nodes.mesh_19.morphTargetInfluences} />
              </group>
              ...
              <group name="Armature_93" position={[0, -0.731, 0]}>
                <group name="GLTF_created_0">
                  ...
                  <skinnedMesh name="Object_57" geometry={nodes.Object_57.geometry} material={materials.spaceame} skeleton={nodes.Object_57.skeleton} morphTargetDictionary={nodes.Object_57.morphTargetDictionary} morphTargetInfluences={nodes.Object_57.morphTargetInfluences} />
                  <skinnedMesh name="Object_59" geometry={nodes.Object_59.geometry} material={materials.spaceame} skeleton={nodes.Object_59.skeleton} morphTargetDictionary={nodes.Object_59.morphTargetDictionary} morphTargetInfluences={nodes.Object_59.morphTargetInfluences} />
                  <skinnedMesh name="Object_67" geometry={nodes.Object_67.geometry} material={materials.spaceameface} skeleton={nodes.Object_67.skeleton} morphTargetDictionary={nodes.Object_67.morphTargetDictionary} morphTargetInfluences={nodes.Object_67.morphTargetInfluences} />
                  <skinnedMesh name="Object_69" geometry={nodes.Object_69.geometry} material={materials.outline} skeleton={nodes.Object_69.skeleton} morphTargetDictionary={nodes.Object_69.morphTargetDictionary} morphTargetInfluences={nodes.Object_69.morphTargetInfluences} />
                </group>
              </group>
            </group>
          </group>
