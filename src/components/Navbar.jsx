      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          <div class="flex items-center space-x-4">
            <img
              src={Profile}
              className="w-10 h-10 rounded-full object-contain shadow-lg cursor-pointer"
          ...
          <div>
            {popup ? (
              ...
              <div className="main sm:block hidden  ">
                  <div className="-mt-10  w-[7000px] h-[10000px]  backdrop-blur-md absolute  right-[-190px]  ">
                   <div className="bg-hero-pattern shadow-card   blue-text-gradien overflow-hidden absolute  right-[690px]  mt-20 py-10 p-5 rounded-2xl sm:w-[460px] w-[1000px]">
                      <p className="text-white mt-[-30px] ">Santosh Rajput</p>
                      ...
                      <div className="text-[30px] absolute left-[20px] top-[620px] ">
                        <a
                          target="_blank"
                          href="https://github.com/Santosh-Rajput"
                          className="text-[#646464] hover:text-white"
                        >
                          <i class="fa-brands fa-github"></i>{" "}
                        </a>
                        <a
                          target="_blank"
                          href="https://instagram.com/santosh___rajput__?utm_source=qr&igshid=MzNlNGNkZWQ4Mg=="
                        ...
                        <a
                          target="_blank"
                          href="https://www.linkedin.com/in/santosh-rajput-052a58182/"
                          className="text-[#055dd0] hover:text-[#013a85]"
                        >
          ...
          >
            ...
            <ul className="list-none flex justify-end items-start flex-1 flex-col gap-4">
              ...
              <div>
                {popup ? (
                  <div className="main ">
                  <div className="  w-[7000px] h-[1000px]  backdrop-blur-md absolute mt-[-100px] right-[-190px]">
                    <div className=" mt-[14.3rem]  rounded-2xl  sm:absolute absolute sm:top-[25%] top-[-20%] right-[194px]  ">
                      <div>
                        <div className="bg-hero-pattern shadow-card   blue-text-gradien overflow-hidden mt-1 py-10 p-5 rounded-2xl sm:w-[460px] w-[330px]">
